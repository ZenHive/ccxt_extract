...
|---|--------|-------|-----------|
| 0 | 🎁 **v4-emit** | Task 130 (NEW) | `--schema-target` CLI gate + `Schema.build_exchange_v4/4` — lands first so each freeze-list task can verify its v4 output as it ships. Mirrors `--pretty` plumbing. |
