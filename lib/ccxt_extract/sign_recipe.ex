defmodule CcxtExtract.SignRecipe do
  ...
  equivalent copy lives under `priv/schema/exchange_v2.json#/$defs/SignRecipeRecord`
  ...
  `priv/schema/exchange_v2.json#/$defs/SignRecipeRecord/required`.
  """
  ...
  copy in `priv/schema/exchange_v2.json`.
  """
